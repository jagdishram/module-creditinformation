 ...
 */
namespace Jag\CreditInformation\Ui\Component\Create\Form\Customer;
...
/**
 * Options tree for "Customer Email" field
 */
class OptionsEmail implements OptionSourceInterface
{
    /**
    ...
    protected function getCustomerTree()
    {
        if ($this->customerTree === null) {
            ...
            foreach ($collection as $customer) {
                ...
                $customerById[$customerId]['label'] = $customer->getEmail();
            }
